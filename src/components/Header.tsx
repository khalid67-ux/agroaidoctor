...
const Header = ({ compact }: HeaderProps) => (
  <header
    className={`gradient-hero ${compact ? "py-1.5" : "pt-.5 pb-1"} shadow-agro flex flex-col items-stretch justify-center relative w-full`}
  >
    <div className="w-full flex items-center justify-start gap-2 pl-6 mt-7 mb-1">
